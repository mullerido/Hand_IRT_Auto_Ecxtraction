...
for kk = 1:10
    ...
    [ALP_model] = ALP_3d_Sum_Iter_Train_4th(ALP_model, f, kk)
...
for kk_t = 1:kk_ind
    ...
    [f_test_approx{kk_t}] = ALP_3d_Sum_Iter_Test_4th(ALP_model, X_test, f_test, kk_t)
     if(kk_t==1)
...
[f_test_approx_4th] = test_approx1_4th(ALP_model, X_test, ALP_model.f_multiscale{kk_ind}, kk_ind);

f_test_approx_4th_flat = reshape(f_test_approx_4th,1,f_Sy*f_Sz);
err_vecB_test1_4th = F_test_true_flat-f_test_approx_4th_flat;
    err_vecB2_test1_4th = err_vecB_test1_4th.^2;
    MSE_err_iterB_test1_4th = sum(err_vecB2_test1_4th)./(f_Sy*f_Sz);
    


[f_test_approx_4th_from_f] = test_approx1_4th(ALP_model, X_test, ALP_model.f, kk_ind);

f_test_approx_4th_flat_from_f = reshape(f_test_approx_4th_from_f,1,f_Sy*f_Sz);
err_vecB_test1_4th_from_f = F_test_true_flat-f_test_approx_4th_flat_from_f;
    err_vecB2_test1_4th_from_f = err_vecB_test1_4th_from_f.^2;
    MSE_err_iterB_test1_4th_from_f = sum(err_vecB2_test1_4th)./(f_Sy*f_Sz);
