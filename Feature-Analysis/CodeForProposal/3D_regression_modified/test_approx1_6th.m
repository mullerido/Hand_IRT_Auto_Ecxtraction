function [f_test_approx] = test_approx1_6th(ALP_model, X_test, f, iter_num)
...
for j=1:f_Sy
    ...
    K2_test = (8*K2_test - 6*K2_test.^2+K2_test.^4)./3;
...
for j=1:f_Sz
    ...
    K3_test = (8*K3_test - 6*K3_test.^2+K3_test.^4)./3;
...
f_test_approx = 0.4*f_test_approx_sub +0.3*f_test_approx_area +0.3*f_test_approx_time;