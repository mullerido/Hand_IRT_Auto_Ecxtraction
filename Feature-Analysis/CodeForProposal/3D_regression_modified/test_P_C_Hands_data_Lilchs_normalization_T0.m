...
err_per_area_cold_sums(1) = err_per_area_cold_kk4(1);
err_per_area_cold_sums(2) = err_per_area_cold_kk4(2);
err_per_area_cold_sums(3) = mean(err_per_area_cold_kk4(3:4));
err_per_area_cold_sums(4) = err_per_area_cold_kk4(5);
err_per_area_cold_sums(5) = mean(err_per_area_cold_kk4(6:10));
err_per_area_cold_sums(6) = mean(err_per_area_cold_kk4(11:15));
figure; bar(err_per_area_cold_sums, 'b');

err_per_area_reg_sums(1) = err_per_area_reg_kk4(1);
err_per_area_reg_sums(2) = err_per_area_reg_kk4(2);
err_per_area_reg_sums(3) = mean(err_per_area_reg_kk4(3:4));
err_per_area_reg_sums(4) = err_per_area_reg_kk4(5);
err_per_area_reg_sums(5) = mean(err_per_area_reg_kk4(6:10));
err_per_area_reg_sums(6) = mean(err_per_area_reg_kk4(11:15));
figure; bar(err_per_area_reg_sums, 'g');


err_per_area_hot_sums(1) = err_per_area_hot_kk4(1);
err_per_area_hot_sums(2) = err_per_area_hot_kk4(2);
err_per_area_hot_sums(3) = mean(err_per_area_hot_kk4(3:4));
err_per_area_hot_sums(4) = err_per_area_hot_kk4(5);
err_per_area_hot_sums(5) = mean(err_per_area_hot_kk4(6:10));
err_per_area_hot_sums(6) = mean(err_per_area_hot_kk4(11:15));
figure; bar(err_per_area_hot_sums, 'r');

figure; subplot(1,3,1); bar(err_per_area_cold_sums, 'b'); hold on; axis([0 7 0 0.3]);
hold on; subplot(1,3,2);  bar(err_per_area_reg_sums, 'g'); hold on; axis([0 7 0 0.3]);
hold on; subplot(1,3,3); bar(err_per_area_hot_sums, 'r'); hold on; axis([0 7 0 0.3]);
...
%% test
 ...
 X_test = reshape(N_Hands_3D_T(4,:,:),15,26);
 F_test_true = reshape(N_Hands_3D_C(4,:,:),15,26);
