...
%   1. hand registration & segmentation.
%   2. Finding Region Of Interest (ROI):
%       - Finger tips (distal) X 5
%       - Finger base (proxy)  X 5
%       - Palm Center square X 1
%       - Palm arch X1
%   3. For each ROI to extract relevant information. For example, the
%       acerage intence, entropy and histogram
%   4. Save this data
%
% The GUI allow the user to perform the task automatically, but also to 
% adjust the result and to perform the segmentation proccess manually.
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
set(handles.baseLinePath, 'string','Enter image path');
